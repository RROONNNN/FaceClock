package com.example.face_native.domain.embeddings
...
class FaceNet(
    ...
    init {
        ...
        interpreter =
            Interpreter(FileUtil.loadMappedFile(context, "facenet_128.tflite"), interpreterOptions)
    }
    ...
    class FaceNetNormalizeOp : TensorOperator {
