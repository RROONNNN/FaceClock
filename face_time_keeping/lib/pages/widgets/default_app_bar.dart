...
class DefaultAppBar extends StatelessWidget with EventBusMixin implements PreferredSizeWidget {
  DefaultAppBar({
    Key? key,
    this.titleText,
    this.title,
      ...
      if (hasDrawer) {
        ...
        if (canPop) {
          leadingIcon = IconButton(
            ...
            icon: Icon(Icons.arrow_back, color: leadingColor ?? AppColors.black,)
          );
        }
      }
    }
